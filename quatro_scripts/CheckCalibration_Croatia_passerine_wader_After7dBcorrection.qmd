---
title: "Check MR1 calibration spring 2023  Passerine & Wader"
...
# Add quantile isolines at specified quantiles (99%, 95%, 90%, 75%, 50%)
  stat_density_2d(aes(color = after_stat(level)), 
                   breaks = c(0.01, 0.05, 0.10, 0.25, 0.50),  # Corresponds to 99%, 95%, 90%, 75%, 50% quantiles
                   contour = TRUE) +
