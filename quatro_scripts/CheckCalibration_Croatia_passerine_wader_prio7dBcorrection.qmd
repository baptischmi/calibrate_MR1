...
editor: visual
params:
  outdir: "C:/Users/bs/OneDrive - Vogelwarte/31403 Radartechnik/SBRS divers/Calibration_MR1/Croatia_2023_passerine_wader_prio7dBcorrection"
execute:
  echo: false
---
...
passerine_plot <- ggplot(filtered_data, aes(x = feature14.maxLevel, y = feature1.altitude_AGL)) +
  ...
  #                  breaks = c(0.01, 0.05, 0.10),  # , 0.25, 0.50
  #                  contour = TRUE,
  #                  linewidth = 1.8) +  # Optional: make lines thicker for better visibility
  # scale_color_viridis_c(option = "plasma", name = "Density",
  #                       labels = c("99%", "95%", "90%")) + # , "75%", "50%"
  stat_density_2d(geom = "density_2d", 
                  aes(color = after_stat(level)),
                  contour_var = "ndensity",  # Use normalized density
                  breaks = c(0.01, 0.05, 0.1, 0.25, 0.5),  # Now these are quantiles , 0.75, 0.90, 0.95, 0.99
                  linewidth = 0.8) +
